...
class MainMenu(tkinter.Tk):
    ...
    # callEnc Function
    # Creates the choose file window, and creates a copy of that file in the
    # current directory. Calls the encrypt function with the name of the temp
    ...
    def callEnc(self):
        ...
        encrypt(getKey(password), newfile)
        os.remove(newfile)
        sys.exit(0)
    # End callEnc
    ...
    # callDec function
    # Creates the choose file window, and creates a copy of that file in the
    # current directory. Calls the decrypt function with the name of the temp
    # file and the hash created from the password in PasswordWindow
    ...
    def callDec(self):
        ...
        decrypt(getKey(password), filenameFromPath(newfile), filename)
        os.remove(newfile)
        sys.exit(0)
    # End callDec
